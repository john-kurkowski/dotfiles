...
hi Typedef guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
hi Title guifg=#f8f8f8 guibg=NONE guisp=NONE gui=bold ctermfg=15 ctermbg=NONE cterm=bold
hi Folded guifg=#798188 guibg=#26292c guisp=#26292c gui=NONE ctermfg=66 ctermbg=234 cterm=NONE
...
hi Float guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
...
hi NonText guifg=#e0e0e0 guibg=#26292c guisp=#26292c gui=NONE ctermfg=255 ctermbg=234 cterm=NONE
...
hi PMenuSel guifg=#ffffff guibg=#3498DB guisp=#82898f gui=bold ctermfg=237 ctermbg=149 cterm=NONE
...
hi Normal guifg=#e0e0e0 guibg=#26292c guisp=#26292c gui=NONE ctermfg=255 ctermbg=234 cterm=NONE
...
hi Character guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
hi Number guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
hi Boolean guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
hi Operator guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=215 ctermbg=NONE cterm=NONE
hi CursorLine guifg=NONE guibg=#2d3033 guisp=#36393c gui=NONE ctermfg=NONE ctermbg=235 cterm=NONE
...
hi ModeMsg guifg=#a0a0a0 guibg=#26292c guisp=#26292c gui=NONE ctermfg=255 ctermbg=234 cterm=NONE
hi Question guifg=#a0a0a0 guibg=#26292c guisp=#26292c gui=NONE ctermfg=255 ctermbg=234 cterm=NONE
hi CursorColumn guifg=NONE guibg=#3b3e40 guisp=#3b3e40 gui=NONE ctermfg=NONE ctermbg=235 cterm=NONE
hi Define guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=215 ctermbg=NONE cterm=NONE
hi Function guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
...
hi Exception guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
hi Keyword guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=215 ctermbg=NONE cterm=NONE
hi Type guifg=#8aC8DB guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
...
hi Constant guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
"hi DefinedName -- no settings --
hi Tag guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
...
hi Repeat guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
"hi SpellBad -- no settings --
"hi CTagsClass -- no settings --

hi Directory guifg=#898d8a guibg=#26292c guisp=#2d3033 gui=NONE ctermfg=237 ctermbg=237 cterm=NONE
hi Structure guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
hi Macro guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=215 ctermbg=NONE cterm=NONE
hi Underlined guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
hi htmlarg guifg=#b7d877 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
...
hi csscommonattr guifg=#b7d877 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
hi rubyescape guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
hi rubyfunction guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
hi rubyrailsuserclass guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
...
hi htmltagname guifg=#b7d877 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
...
hi csscolor guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
hi rubyconstant guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
hi rubyrailsmethod guifg=#ffb454 guibg=NONE guisp=NONE gui=NONE ctermfg=221 ctermbg=NONE cterm=NONE
...
hi htmltag guifg=#b7d877 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
...
hi csspseudoclassid guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
hi colorcolumn guifg=NONE guibg=#3b3e40 guisp=#3b3e40 gui=NONE ctermfg=NONE ctermbg=237 cterm=NONE
hi cssvaluelength guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
...
hi rubysymbol guifg=#b8d977 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE
...
hi cssclassname guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
hi yamlkey guifg=#72aaca guibg=NONE guisp=NONE gui=NONE ctermfg=074 ctermbg=NONE cterm=NONE
hi rubyoperator guifg=#fa9a4b guibg=NONE guisp=NONE gui=NONE ctermfg=215 ctermbg=NONE cterm=NONE
"hi clear -- no settings --
hi htmlendtag guifg=#b7d877 guibg=NONE guisp=NONE gui=NONE ctermfg=149 ctermbg=NONE cterm=NONE



" NerdTree
hi Directory guifg=#898d8a guibg=#26292c guisp=#2d3033 gui=NONE ctermfg=255 ctermbg=234 cterm=NONE
